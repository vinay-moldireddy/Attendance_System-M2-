	...
	<div class="container pannelcont">
		<div class="panel panel-primary">
            ...
            <div class="panel-body" >
            	<form method="get" action="studentpage.php">
            		<br><input type="integer" class="form-control" name="id" placeholder="Student id"><br>
            		<input type="Password" class="form-control" name="password" placeholder="password"><br>
            		<input type="submit" name="submit" value="Login" class=" btn btn-primary">
            	</form>
            </div>
            <div class="panel-footer">Contact Teacher if you are not Signed Up <a href="signup.html"> </a></div>
        </div>
	</div>
	<?php
	include 'footer.php';
